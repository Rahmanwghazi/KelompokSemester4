...
void satu(){
  ...
  if (Error2>=LastError2){
   ...
   if (timeChange>SampleTime){
    ...
    kecepatanMotorKanan = kecepatanNow -moveControl;
    kecepatanMotorKiri = kecepatanNow + moveControl;
...
void timer(){
  ...
  if(now%2==0){
    if(Error==0){
      kecepatanSetPoint+=20;
      kecepatanNow=kecepatanSetPoint;
    }else{
      kecepatanNow=150;
    }
    
  }Serial.print("kecepatanNow = ");
